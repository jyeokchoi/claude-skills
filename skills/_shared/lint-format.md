...
`rules/project-params.local.md`에 `lint_command`/`format_command`가 있으면 사용한다. 없으면 프로젝트에서 자동 탐지:

```bash
# 1. rules/project-params.local.md에서 lint_command / format_command 읽기 (있으면 사용)
